      ...
      <div className="grid-3">
        ...
        <div className="oneof flexrow center">
          ...
          <div className="info">
            ...
            <p>phone: {props.order.shipping.phon || ""}</p>
        ...
        <div className="oneof flexrow center">
          ...
          <div className="info">
            ...
            <p>pay method: {props.pyment.type || ""}</p>
            <p
              className={
                props.pyment.ispaid == "no" ? "colorroyalblue" : "colorgreen"
              }
            >
              {" "}
              <strong>is paid: {props.pyment.ispaid || ""}</strong>{" "}
            </p>
          </div>
        </div>
      </div>
